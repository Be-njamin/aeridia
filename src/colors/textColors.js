...
module.exports = {
  'textBlockQuote.background': theme.blackDarkest,
  'textBlockQuote.border': theme.blackLighter,
  'textCodeBlock.background': theme.blackDarkest,
  'textLink.activeForeground': theme.cyan,
