...
module.exports = {
  'extensionButton.prominentForeground': theme.whiteDarkest,
  'extensionButton.prominentBackground': theme.magentaDarker,
  'extensionButton.prominentHoverBackground': theme.transparent,
